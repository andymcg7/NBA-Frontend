...
angular.module('NBAApp')
  .service('createLeagueMatchTransferObjectService', function() {
    ...
    function createTransferObject(leagueMatch) {
      ...
      postdata.id = leagueMatch.id;

      postdata.matchType = leagueMatch.matchType;
      postdata.division = leagueMatch.division;
      postdata.matchDate = leagueMatch.matchDate;
      ...
      postdata.dateString = formattedDate(parseInt(leagueMatch.matchDate, 10));

      postdata.homePair1Player1 = leagueMatch.homePair1Player1;
      postdata.homePair1Player2 = leagueMatch.homePair1Player2;
      postdata.homePair2Player1 = leagueMatch.homePair2Player1;
      postdata.homePair2Player2 = leagueMatch.homePair2Player2;
      postdata.homePair3Player1 = leagueMatch.homePair3Player1;
      postdata.homePair3Player2 = leagueMatch.homePair3Player2;

      postdata.awayPair1Player1 = leagueMatch.awayPair1Player1;
      postdata.awayPair1Player2 = leagueMatch.awayPair1Player2;
      postdata.awayPair2Player1 = leagueMatch.awayPair2Player1;
      postdata.awayPair2Player2 = leagueMatch.awayPair2Player2;
      postdata.awayPair3Player1 = leagueMatch.awayPair3Player1;
      postdata.awayPair3Player2 = leagueMatch.awayPair3Player2;
      ...
      postdata.verifyLeagueMatch = 'true';
