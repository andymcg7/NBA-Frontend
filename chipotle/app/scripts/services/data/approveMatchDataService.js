...
angular.module('NBAApp')
  .service('approveMatchDataService', function($http, $httpParamSerializerJQLike, createLeagueMatchTransferObjectService) {

    var approveMatch = function(url, leagueMatch) {
